...
export const products: Product[] = [
  {
    ...
    faqs: [
      { question: 'What is the minimum order quantity?', answer: 'Our MOQ is 0.5 MT per order. We can accommodate smaller trial orders upon request.' },
  ...
  */
  {
    ...
    faqs: [
      { question: 'Is organic chilli powder available?', answer: 'Yes, we offer certified organic chilli powder on request with minimum 0.5 MT order.' },
