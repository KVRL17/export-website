...
export const testimonials: Testimonial[] = [
  {
    ...
    flag: '🇦🇪',
    rating: 5,
    text: 'We have been sourcing premium basmati rice from Akshyaa Global Exports for 3 years. The quality is consistently excellent, documentation is always on time, and pricing is very competitive.',
  ...
  },
  {
    ...
    flag: '🇬🇧',
    rating: 5,
    text: 'Exceptional quality red chilli powder and flakes. ASTA color values are always as specified, and the HACCP certification gives us confidence for our food service clients.',
  ...
  },
  {
    ...
    flag: '🇲🇾',
    rating: 5,
    text: 'Their non-basmati rice is clean, well-packed, and arrives in perfect condition. The private labeling service and reliable lead times make them a strong partner.',
  ...
  },
  {
    ...
    flag: '🇸🇦',
    rating: 5,
    text: 'Reliable supplier for dried red chillies and chilli products. We have never had a quality complaint, and their pre-shipment documentation is smooth and professional.',
    avatar: 'https://images.pexels.com/photos/2182970/pexels-photo-2182970.jpeg?auto=compress&cs=tinysrgb&w=150',
    product: 'Dried Red Chillies',
  },
];
